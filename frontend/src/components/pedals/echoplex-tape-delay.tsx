...
const pedalId = 'echoplex-tape-delay'

/**
 * Composant complet de la pédale Echoplex Tape Delay
 * Layout simple : 3 knobs en ligne
 */
export function EchoplexTapeDelayPedal({ 
  values = {}, 
  onChange, 
  bypassed = false,
  onBypassToggle,
...
export const EchoplexTapeDelayControls = ({
  values = {},
  onChange,
  accentColor,
}: PedalComponentProps) => {
...
export default EchoplexTapeDelayPedal
