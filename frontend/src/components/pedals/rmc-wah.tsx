...
const pedalId = 'rmc-wah'

/**
 * Composant complet de la pédale RMC Wah (Custom Wah)
 * Layout : 3 knobs (ligne 1: 2 knobs, ligne 2: 1 knob centré)
 */
export function RmcWahPedal({ 
  values = {}, 
  onChange, 
  bypassed = false,
  onBypassToggle,
