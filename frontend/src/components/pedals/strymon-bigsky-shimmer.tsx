...
const pedalId = 'strymon-bigsky-shimmer'

/**
 * Composant complet de la pédale Strymon BigSky Shimmer
 * Layout : 3 knobs (ligne 1: 2 knobs, ligne 2: 1 knob centré)
 */
export function StrymonBigskyShimmerPedal({ 
  values = {}, 
  onChange, 
  bypassed = false,
  onBypassToggle,
...
export default StrymonBigskyShimmerPedal
