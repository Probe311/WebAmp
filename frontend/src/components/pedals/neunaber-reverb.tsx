...
const pedalId = 'neunaber-reverb'

/**
 * Composant complet de la pédale Neunaber Reverb (Ambient)
 * Layout : 3 knobs (ligne 1: 2 knobs, ligne 2: 1 knob centré)
 */
export function NeunaberReverbPedal({ 
  values = {}, 
  onChange, 
  bypassed = false,
  onBypassToggle,
...
export const NeunaberReverbControls = ({
  values = {},
  onChange,
  accentColor,
}: PedalComponentProps) => {
...
export default NeunaberReverbPedal
