...
const pedalId = 'fulltone-supatrem'

/**
 * Composant complet de la pédale Fulltone Supa-Trem
 * Layout simple : 3 knobs en ligne
 */
export function FulltoneSupatremPedal({ 
  values = {}, 
  onChange, 
  bypassed = false,
  onBypassToggle,
...
export const FulltoneSupatremControls = ({
  values = {},
  onChange,
  accentColor,
}: PedalComponentProps) => {
...
export default FulltoneSupatremPedal
