...
const pedalId = 'fulltone-ocd'

/**
 * Composant complet de la pédale Fulltone OCD
 * Layout simple : 3 knobs + switch-selector
 */
export function FulltoneOcdPedal({ 
  values = {}, 
  onChange, 
  bypassed = false,
  onBypassToggle,
...
export const FulltoneOcdControls = ({
  values = {},
  onChange,
}: PedalComponentProps) => {
...
export default FulltoneOcdPedal
