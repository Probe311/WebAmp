...
const pedalId = 'killswitch-stutter'

/**
 * Composant complet de la pédale Killswitch Stutter
 * Layout simple : 1 knob
 */
export function KillswitchStutterPedal({ 
  values = {}, 
  onChange, 
  bypassed = false,
  onBypassToggle,
...
export const KillswitchStutterControls = ({
  values = {},
  onChange,
}: PedalComponentProps) => {
...
export default KillswitchStutterPedal
