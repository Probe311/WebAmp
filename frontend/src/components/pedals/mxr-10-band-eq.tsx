...
const pedalId = 'mxr-10-band-eq'

/**
 * Composant complet de la pédale MXR 10-Band EQ
 * Layout spécial : 10 sliders verticaux pour les bandes EQ + slider level séparé
 */
export function Mxr10BandEqPedal({ 
  values = {}, 
  onChange, 
  bypassed = false,
  onBypassToggle,
...
export default Mxr10BandEqPedal
