...
const pedalId = 'tc-delay'

/**
 * Composant complet de la pédale TC Delay (2290 Style)
 * Layout : 3 knobs (ligne 1: 2 knobs, ligne 2: 1 knob centré)
 */
export function TcDelayPedal({ 
  values = {}, 
  onChange, 
  bypassed = false,
  onBypassToggle,
