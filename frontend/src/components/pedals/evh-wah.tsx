...
const pedalId = 'evh-wah'

/**
 * Composant complet de la pédale EVH Wah (Signature Wah)
 * Layout : 3 knobs (ligne 1: 2 knobs, ligne 2: 1 knob centré)
 */
export function EvhWahPedal({ 
  values = {}, 
  onChange, 
  bypassed = false,
  onBypassToggle,
