...
const pedalId = 'ibanez-tube-screamer-mini'

/**
 * Composant complet de la pédale Ibanez Tube Screamer Mini
 * Layout simple : 3 knobs en ligne
 */
export function IbanezTubeScreamerMiniPedal({ 
  values = {}, 
  onChange, 
  bypassed = false,
  onBypassToggle,
...
export const IbanezTubeScreamerMiniControls = ({
  values = {},
  onChange,
  accentColor,
}: PedalComponentProps) => {
...
export default IbanezTubeScreamerMiniPedal
