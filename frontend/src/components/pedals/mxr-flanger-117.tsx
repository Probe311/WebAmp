...
const pedalId = 'mxr-flanger-117'

/**
 * Composant complet de la pédale MXR Flanger 117
 * Layout simple : 4 knobs en ligne
 */
export function MxrFlanger117Pedal({ 
  values = {}, 
  onChange, 
  bypassed = false,
  onBypassToggle,
...
export const MxrFlanger117Controls = ({
  values = {},
  onChange,
}: PedalComponentProps) => {
...
export default MxrFlanger117Pedal
