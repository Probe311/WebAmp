...
const pedalId = 'eventide-harmonizer'

/**
 * Composant complet de la pédale Eventide Harmonizer
 * Layout simple : 3 knobs en ligne
 */
export function EventideHarmonizerPedal({ 
  values = {}, 
  onChange, 
  bypassed = false,
  onBypassToggle,
...
export const EventideHarmonizerControls = ({
  values = {},
  onChange,
  accentColor,
}: PedalComponentProps) => {
...
export default EventideHarmonizerPedal
