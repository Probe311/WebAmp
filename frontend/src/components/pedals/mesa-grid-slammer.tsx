...
const pedalId = 'mesa-grid-slammer'

/**
 * Composant complet de la pédale Mesa Grid Slammer
 * Layout simple : 3 knobs en ligne
 */
export function MesaGridSlammerPedal({ 
  values = {}, 
  onChange, 
  bypassed = false,
  onBypassToggle,
...
export const MesaGridSlammerControls = ({
  values = {},
  onChange,
}: PedalComponentProps) => {
...
export default MesaGridSlammerPedal
