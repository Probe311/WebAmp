...
import { Shield, CircleDot, Plus } from 'lucide-react'
...
const pedalId = 'walrus-audio-fuzz'
const ACCENT_COLOR = '#FFC05F'

/**
 * Composant complet de la pédale Walrus Audio Fuzz
 * Layout spécial : 3 sliders horizontaux + switch-selector en bas
 */
export function WalrusAudioFuzzPedal({ 
  values = {}, 
  onChange, 
  bypassed = false,
  onBypassToggle,
...
export default WalrusAudioFuzzPedal
