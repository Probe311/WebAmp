...
const pedalId = 'digitech-whammy'

/**
 * Composant complet de la pédale Digitech Whammy
 * Layout simple : 1 knob + switch-selector
 */
export function DigitechWhammyPedal({ 
  values = {}, 
  onChange, 
  bypassed = false,
  onBypassToggle,
...
export const DigitechWhammyControls = ({
  values = {},
  onChange,
}: PedalComponentProps) => {
...
export default DigitechWhammyPedal
