...
const pedalId = 'ibanez-tube-screamer'

/**
 * Composant complet de la pédale Ibanez Tube Screamer TS9
 * Layout simple : 3 knobs en ligne
 */
export function IbanezTubeScreamerPedal({ 
  values = {}, 
  onChange, 
  bypassed = false,
  onBypassToggle,
...
export const IbanezTubeScreamerControls = ({
  values = {},
  onChange,
  accentColor,
}: PedalComponentProps) => {
...
export default IbanezTubeScreamerPedal
