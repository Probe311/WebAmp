...
const pedalId = 'tc-electronic-flashback'

/**
 * Composant complet de la pédale TC Electronic Flashback
 * Layout simple : 3 knobs en ligne
 */
export function TcElectronicFlashbackPedal({ 
  values = {}, 
  onChange, 
  bypassed = false,
  onBypassToggle,
...
export const TcElectronicFlashbackControls = ({
  values = {},
  onChange,
}: PedalComponentProps) => {
...
export default TcElectronicFlashbackPedal
