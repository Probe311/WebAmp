...
const pedalId = 'electro-harmonix-big-muff'

/**
 * Composant complet de la pédale Electro-Harmonix Big Muff
 * Layout simple : 4 knobs
 */
export function ElectroHarmonixBigMuffPedal({ 
  values = {}, 
  onChange, 
  bypassed = false,
  onBypassToggle,
...
export const ElectroHarmonixBigMuffControls = ({
  values = {},
  onChange,
  accentColor
}: PedalComponentProps) => {
...
export default ElectroHarmonixBigMuffPedal
